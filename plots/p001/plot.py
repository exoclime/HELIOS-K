...
pl.plot(y0*30000/5.0, k0, lw = 2, label ='bin 0 $\kappa(y)$')
pl.plot(y1*30000/5.0 + 1 * 30000 / 5.0, k1, lw = 2, label ='bin 1 $\kappa(y)$')
pl.plot(y2*30000/5.0 + 2 * 30000 / 5.0, k2, lw = 2, label ='bin 2 $\kappa(y)$')
pl.plot(y3*30000/5.0 + 3 * 30000 / 5.0, k3, lw = 2, label ='bin 3 $\kappa(y)$')
pl.plot(y4*30000/5.0 + 4 * 30000 / 5.0, k4, lw = 2, label ='bin 4 $\kappa(y)$')
